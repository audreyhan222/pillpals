                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              child: FilledButton(
                                onPressed: () async {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Saved: ${apiConfig.baseUrl}'),
                                    ),
                                  );
                                },
                            ...
                            Expanded(
                              child: FilledButton.tonal(
                                onPressed: () async {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Reset to default: ${apiConfig.baseUrl}'),
                                    ),
                                  );
                                },
                        ...
                        const SizedBox(height: 10),
                        const _SectionHint(
                          'If you are running on a real phone, 127.0.0.1 points to the phone, not your Mac. Use your Mac’s LAN IP (and run the backend with host 0.0.0.0).',
                        ),
